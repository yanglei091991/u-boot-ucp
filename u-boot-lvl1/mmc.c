...
//#if CONFIG_IS_ENABLED(MMC_UHS_SUPPORT)
	...
	sd3_bus_mode = uswap_32(switch_status[3]) >> 16 & 0x1f;
...
#endif
    debug("sd card caps= 0x%x\n\r", card_caps);
    debug("host caps= 0x%x\n\r", mmc->host_caps);
